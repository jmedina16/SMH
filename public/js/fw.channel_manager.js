...
//        });
    ...
    selectProgram: function (origin) {
        ...
        content = '<div class="channel-tab tabbable">' +
                ...
                '</li>' +
                '<li>' +
                '<div class="checkbox"><label><input type="checkbox" value="201" class="media_list"> Live Stream</label></div>' +
                '</li>' +
                '</ul>' +
                '</div>' +
...
//        console.log(id);
    ...
    previewEmbedSchedule: function () {
        ...
        content = '<div class="content">' +
                ...
                '</div>' +
                '<div class="clear"></div>' +
                '<span style="color: #444; font-size: 12px; font-weight: bold;">Width</span><input type="text" value="201" id="dim_width" name="dim_width" style="width: 70px; margin-left: 10px; display: inline;" class="form-control" disabled><span> %</span>' +
                '<div class="right-ar">' +
