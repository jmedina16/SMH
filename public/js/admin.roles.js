...
Roles.prototype = {
    ...
    addRole:function(){    
        ...
        '<div class="checkbox"><label><input type="checkbox" style="width=33px" id="content_clip">Clipping</label></div>'+
        ...
        '<div class="checkbox"><label><input type="checkbox" style="width=33px" id="content_edit_ad">Edit Entry Advertisement</label></div>'+
        '<div class="checkbox"><label><input type="checkbox" style="width=33px" id="content_edit_cap">Edit Entry Captions</label></div>'+
        ...
        '<div class="box-header">'+
        '<h4 class="box-title">'+
        '<span class="title">Player Management</span><span class="link"><a data-toggle="collapse" data-parent="#accordion" href="#collapseFour" class="collapsed toggle-accordion" aria-expanded="false">'+
        '</a></span>'+
        '</h4>'+
        '<div class="clear"></div>'+
        '</div>'+
        ...
        '<div class="box-body">'+
        '<div class="checkbox"><label><input type="checkbox" style="width=33px" id="player_create">Create Players</label></div>'+
        '<div class="checkbox"><label><input type="checkbox" style="width=33px" id="player_modify">Modify Players</label></div>'+
        '<div class="checkbox"><label><input type="checkbox" style="width=33px" id="player_delete">Delete Players</label></div>'+
        '<div class="checkbox"><label><input type="checkbox" style="width=33px" id="player_select_content">Select Player Content</label></div>'+
        '</div>'+
        '</div>'+
        '</div>'+
        '<div class="item">'+
        '<div class="box-header">'+
        '<h4 class="box-title">'+
        '<span class="title">Advertising</span><span class="link"><a data-toggle="collapse" data-parent="#accordion" href="#collapseFive" class="collapsed toggle-accordion" aria-expanded="false">'+
        '</a></span>'+
        '</h4>'+
        '<div class="clear"></div>'+
        '</div>'+
        ...
        '<div class="box-body">'+
        '<div class="checkbox"><label><input type="checkbox" style="width=33px" id="set_ad_settings">Set Advertising Settings</label></div>'+
        '</div>'+
        '</div>'+
        '</div>'+
        '<div class="item">'+
    ...
    createRole:function(){
        ...
        if(valid){
            ...
            var content_clip = ($('#content_clip').prop('checked')) ? 1 : 0;
            ...
            var content_edit_ad = ($('#content_edit_ad').prop('checked')) ? 1 : 0;
            var content_edit_cap = ($('#content_edit_cap').prop('checked')) ? 1 : 0;
            ...
            var player_create = ($('#player_create').prop('checked')) ? 1 : 0;
            var player_modify = ($('#player_modify').prop('checked')) ? 1 : 0;
            var player_delete = ($('#player_delete').prop('checked')) ? 1 : 0;
            var player_select_content = ($('#player_select_content').prop('checked')) ? 1 : 0;
            var set_ad_settings = ($('#set_ad_settings').prop('checked')) ? 1 : 0;
            ...
            if(content_metadata || content_modify_refid || content_entry_cat || content_modify_thumb || content_modify_ac || content_delete || content_grab_embed || content_manage_flavors || content_clip || content_edit_cat || content_update_live_stream || content_download || content_edit_ad || content_edit_cap || content_edit_related){
                ...
                if(content_clip){
                    content_perm += ',CONTENT_INGEST_CLIP_MEDIA';  
                }
                if(content_edit_cat){
                ...
                if(content_edit_ad){
                    content_perm += ',cuePoint.MANAGE';  
                }
                if(content_edit_cap){
                    content_perm += ',CAPTION_MODIFY';  
                }
            ...
            if(player_create || player_modify || player_delete || player_select_content){
                player_perm += ',STUDIO_BASE';
                if(player_create){
                    player_perm += ',STUDIO_ADD_UICONF'; 
                }
                if(player_modify){
                    player_perm += ',STUDIO_UPDATE_UICONF'; 
                }
                if(player_delete){
                    player_perm += ',STUDIO_DELETE_UICONF'; 
                }
                if(player_select_content){
                    player_perm += ',STUDIO_SELECT_CONTENT'; 
                }
            }
            if(set_ad_settings){
                ad_perm += ',ADVERTISING_UPDATE_SETTINGS';
            }
            if(view_analytics){
            ...
            permissions += ingest_perm + content_perm + plist_perm + player_perm + ad_perm + analytics_perm + account_perm + ac_perm + trans_perm + admin_perm + smh_perm + smh_mem_perm + smh_wl_perm;
    ...
    editRole:function(role_id,role_name,role_desc,role_perms){
        ...
        var content_clip_check = ($.inArray("CONTENT_INGEST_CLIP_MEDIA", permissions) != -1)? 'checked' : '';
        ...
        var content_edit_ad_check = ($.inArray("cuePoint.MANAGE", permissions) != -1)? 'checked' : '';
        var content_edit_cap_check = ($.inArray("CAPTION_MODIFY", permissions) != -1)? 'checked' : '';
        ...
        var player_create_check = ($.inArray("STUDIO_ADD_UICONF", permissions) != -1)? 'checked' : '';
        var player_modify_check = ($.inArray("STUDIO_UPDATE_UICONF", permissions) != -1)? 'checked' : '';
        var player_delete_check = ($.inArray("STUDIO_DELETE_UICONF", permissions) != -1)? 'checked' : '';
        var player_select_content_check = ($.inArray("STUDIO_SELECT_CONTENT", permissions) != -1)? 'checked' : '';
        var set_ad_settings_check = ($.inArray("ADVERTISING_UPDATE_SETTINGS", permissions) != -1)? 'checked' : '';
        ...
        '<div class="checkbox"><label><input '+content_clip_check+' type="checkbox" style="width=33px" id="content_clip">Clipping</label></div>'+
        ...
        '<div class="checkbox"><label><input '+content_edit_ad_check+' type="checkbox" style="width=33px" id="content_edit_ad">Edit Entry Advertisement</label></div>'+
        '<div class="checkbox"><label><input '+content_edit_cap_check+' type="checkbox" style="width=33px" id="content_edit_cap">Edit Entry Captions</label></div>'+
        ...
        '<div id="collapseFour" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">'+
        '<div class="box-body">'+
        '<div class="checkbox"><label><input '+player_create_check+' type="checkbox" style="width=33px" id="player_create">Create Players</label></div>'+
        '<div class="checkbox"><label><input '+player_modify_check+' type="checkbox" style="width=33px" id="player_modify">Modify Players</label></div>'+
        '<div class="checkbox"><label><input '+player_delete_check+' type="checkbox" style="width=33px" id="player_delete">Delete Players</label></div>'+
        '<div class="checkbox"><label><input '+player_select_content_check+' type="checkbox" style="width=33px" id="player_select_content">Select Player Content</label></div>'+
        '</div>'+
        '</div>'+
        '</div>'+
        '<div class="item">'+
        ...
        '<div id="collapseFive" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">'+
        '<div class="box-body">'+
        '<div class="checkbox"><label><input '+set_ad_settings_check+' type="checkbox" style="width=33px" id="set_ad_settings">Set Advertising Settings</label></div>'+
        '</div>'+
        '</div>'+
        '</div>'+
        '<div class="item">'+
