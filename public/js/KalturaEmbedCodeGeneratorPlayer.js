...
//  else { stack1 = depth0.scriptUrl; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  ...
  if(depth0.sizing === 'fixed' || depth0.preview){
      buffer += escapeExpression(stack1)
      buffer += "\n<div id=\"";
      if (stack1 = helpers.playerId) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
      else { stack1 = depth0.playerId; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
      ...
      buffer += "\n<div style=\"max-width: "+depth0.width+"px;width: 100%;display: inline-block;position: relative;\">\n";
      if(depth0.aspectRatio === '4:3'){
          buffer += "<div style=\"margin-top: 75%;\"></div>\n";
      } else {
          buffer += "<div style=\"margin-top: 56.25%;\"></div>\n";
      }
      buffer += "<div id=\""+depth0.playerId+"\" style=\"position:absolute;top:0;left:0;left: 0;right: 0;bottom:0;\"></div>\n";
  }    
...
function program1(depth0,data) {
  ...
  if(depth0.sizing === 'responsive' && depth0.preview === false){
      buffer += "<div style=\"max-width: "+depth0.width+"px;width: 100%;display: inline-block;position: relative;\">\n";
      if(depth0.aspectRatio === '4:3'){
          buffer += "<div style=\"margin-top: 75%;\"></div>\n";
      } else {
          buffer += "<div style=\"margin-top: 56.25%;\"></div>\n";
  ...
  if(depth0.sizing === 'fixed' || depth0.preview){
    ...
    buffer += escapeExpression(stack2)
    buffer += "\" ";
  } else if(depth0.sizing === 'responsive' && depth0.preview === false){
    buffer += "style=\"width:100%;height:100%;position:absolute;top:0;left:0;left: 0;right: 0;bottom:0;\" ";
  }
  
  buffer += "allowfullscreen webkitallowfullscreen mozAllowFullScreen allow=\"autoplay *; fullscreen *; encrypted-media *\" frameborder=\"0\"";
  options = {hash:{},data:data};
  stack2 = ((stack1 = helpers.elAttributes),stack1 ? stack1.call(depth0, depth0.attributes, options) : helperMissing.call(depth0, "elAttributes", depth0.attributes, options));
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += ">";
...
helpers = helpers || Handlebars.helpers; data = data || {};
  ...
  return "<a href=\"https://streamingmediahosting.com/\">Content Delivery Network</a>\n<a href=\"https://streamingmediahosting.com/tools/video_platform/\">Online Video Platform</a> \n<a href=\"https://streamingmediahosting.com/tools/audio_video_players/\">Streaming Video Players</a>\n<a href=\"https://streamingmediahosting.com/services/\">Streaming Media Hosting Services</a>";
  });
...
function program3(depth0,data) {
  ...
  buffer += escapeExpression(stack1)
    + "\" type=\"application/x-shockwave-flash\" allowFullScreen=\"true\" allowNetworking=\"all\" wmode=\"opaque\" allowScriptAccess=\"always\" height=\"";
  if (stack1 = helpers.height) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.height; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "\" width=\"";
