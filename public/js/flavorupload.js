...
Upload.prototype = {
    ...
    init_fileupload: function () {
        ...
        $('#fileupload').fileupload({
            ...
            retryTimeout: 500,
            multipart: false,
            acceptFileTypes: /(\.|\/)(mp4|flv|f4v|m4v|asf|mov|avi|3gp|ogg|mkv|wmv|wma|webm|mpeg|mpg|m1v|m2v|wav|mp3|aac|flac|ac3)$/i,
            ...
            add: function (e, data) {
                if (fileNumber > 1) {
                    ...
                    if (fileCount > maxFiles || numberOfFiles >= 1) {
                        ...
                        $('#upload-head').css('display', 'none');
                        $('.fileupload-buttonbar').css('margin-top', '50px');
            ...
            fail: function (e, data) {
                if (data.errorThrown == 'abort') {
                    ...
                    $('#upload-head').css('display', 'inline-block');
                    $('.fileupload-buttonbar').css('margin-top', '0px');
                    var numberOfFiles = $(this).fileupload('option').getNumberOfFiles();
                    if (numberOfFiles == 1) {
            ...
            beforeSend: function (e, files, index, xhr, handler, callback) {
                ...
                $.ajax({
                    ...
                    success: function (r) {
                        $('.fileupload-buttonbar').html('<div class="upload-finish">Upload Complete</div>');
                        data.context.html('<td colspan="4"><div style="text-align: left;"><h5 style="color: green;">Done</h5></div></td>');
                    }
                });
            }
        });
