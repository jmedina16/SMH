...
MEM.prototype = {
    ...
    previewEmbed:function(sm_ak,uiconf,player_width,player_height,eid,mode,wrap_width){
        ...
        content = '<iframe id="trim-clip" allowfullscreen webkitallowfullscreen mozallowfullscreen scrolling="no" width="100%" height="100%" frameborder="0" src="/apps/platform/vr_preview_embed_mem.php?pid='+sessInfo.pid+'&sm_ak='+sm_ak+'&ks='+sessInfo.ks+'&uiconf_id='+uiconf+'&width='+player_width+'&height='+player_height+'&entry_id='+eid+'&mode='+mode+'&wrap_width='+wrap_width+'">';       
    ...
    addSingleEntry:function(){
        ...
        '<li style="width: 50%;"><a href="#ac-tab" data-toggle="tab">ASSIGN ACCESS CONTROL</a></li>'+
        '</ul>'+
        '</div>'+
