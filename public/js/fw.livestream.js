...
LiveStreams.prototype = {
    ...
    previewEmbed: function (entryId, name, platforms) {
        ...
        if (smh) {
            ...
            player_prev_gen = smhLS.generateEmbed(uiconf_id, entryId, width, height, 'http', delivery, embed, seo, name, true, sizing, ratio);
    ...
    displayBroadcastSettings: function (id, name, bitrates, streamName, platforms) {
        ...
        $.each(temp, function (index, value) {
            temp_arr.push([value.width, value.height, value.bitrate]);
        });
