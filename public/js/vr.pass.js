...
Pass.prototype = {
    ...
    pass_succ:function(){
        ...
        '<p>You will now be redirected to the login page. If you are not redirected, please click on the following link: <a href="https://vr.streamingmediahosting.com">https://vr.streamingmediahosting.com</a></p>'+
        '</div>'; 
        $('#smh-modal .modal-body').html(content);
        
        setTimeout(function(){
            window.location.href = "https://vr.streamingmediahosting.com";
        },5000); 
    },
    error_ne:function(){
        smhPass.resetModal();
