        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.Error) {
                    ...
                    if (data.result.transcoding_file_size) {
                        transcoding = smhDash.formatStorage(data.result.transcoding_file_size);
                    } else {
                        transcoding = "0.00 MB";
                    }
                }
                ...
                $('#user-transcoding').html(smhDash.format(transcoding));
            }
        });
    },
