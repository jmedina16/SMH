...
(function (factory) {
    ...
    // The File Upload Kaltura plugin extends the fileupload widget
    // with Kaltura upload functionality:
    $.widget('blueimp.fileupload', $.blueimp.fileupload, {
        ...
        _create: function () {
            ...
            $.ajaxPrefilter(function (options, originalOptions, jqXHR) {
                ...
                //if we're doing upload and we're in IE8/9 we need to change the format from json to xml
                if (urlParams.action == "upload" &&
                        (/msie 7/.test(navigator.userAgent.toLowerCase())) || // required for IE9 compat.mode
                        (/msie 8/.test(navigator.userAgent.toLowerCase())) ||
                        (/msie 9/.test(navigator.userAgent.toLowerCase()))) {
