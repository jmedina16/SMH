...
kmc.preview_embed = {
	...
	embed_code_template :	{
		...
		object_tag :	'<object id="smh_player_{CACHE_ST}" name="smh_player_{CACHE_ST}" type="application/x-shockwave-flash" allowFullScreen="true" ' +
		...
		iframe_tag : 	'<iframe id="smh_player_{CACHE_ST}" name="smh_player" src="{IFRAME_URL}"' +
