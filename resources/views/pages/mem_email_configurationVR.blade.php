            ...
            <div class="col-md-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div style="width: 100%; text-align: center; margin-bottom: 10px;"><div id="loading"><img height="20px" src="/img/loading.gif"></div><button id="save_config" class="btn btn-primary" onclick="smhMEM.saveConfig(); return false;">Save Changes</button><div id="pass-result"></div></div>
                        <div class="clear"></div>
                    </div>
                </div>
            </div>
...
<script src="/js/mem.email.configuration.js?v=1" type="text/javascript"></script>
@stop