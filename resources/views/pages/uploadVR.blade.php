            ...
            <div class="col-md-12">
                <div id="page-header-wrapper"> 
                    <div id="page-header-body">
                        <div id="text">Designed specifically for large VR files with resumable uploads utilizing chunking technology.</div>
...
<script src="/js/vr.upload.js?v=1" type="text/javascript"></script>
@stop