            ...
            <div class="col-md-12">
                <div id="page-header-wrapper">
                    <div id="page-header-body">
                        <div id="text">A user account consists of both a user name and a password that allows access to your pay-per-view content. Once a user is logged in, they can view their purchased videos. You can manually add a user account or a user can easily register through the player widget.</div>
                    ...
                    <div class="box-body">
                        <form id="config-form" action="">
                            <table id="gateway-table">
                                ...
                                <tr>
                                    <td style="width: 300px;"><div style="margin-left: 10px;">User Registration Form</div></td><td><div style="display: inline-block; float: left;"><button class="btn btn-block btn-primary" id="edit-reg" onclick="smhPPV.editReg(); return false;">Registration Form</button></div><div class="clear"></div><div style="margin-top: 5px; color: #999;"><i>Add up to 5 additional form fields to the user registration form.</i></div></td>
                                </tr>
                            </table>
                        </form>
                    </div>
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="rs-right-header"><a href="#" id="refresh" onclick="smhPPV.getUsers();"><i class="fa fa-refresh"></i> Refresh</a></div>
                    </div>
                    <div class="box-body">
                        <div id="users-buttons">
                            <div style="display: inline-block; float: left;">
                                <button class="btn btn-block bg-olive" id="add-user" onclick="smhPPV.addUser();">Create User</button>
                            </div>
...
<script src="/js/ppv.users.js?v=1" type="text/javascript"></script>
@stop