...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1><i class="fa fa-wifi"></i> Live VR</h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Live VR</li>
        </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="col-md-12">
                <div id="page-header-wrapper">  
                    <div id="page-header-body">
                        <div id="text">Create, broadcast, and record live vr streams.</div>
                    ...
                    <div class="box-body" id="livestream-table-wrapper">
                        <div id="users-buttons">
                            <div style="display: inline-block; float: left;">
                                <span style="display: inline-block; float: left;"><button class="btn btn-block bg-olive" id="add-livestream" onclick="smhLS.addLiveStream();" {{ (in_array("LIVE_STREAM_ADD", $permissions))? '' : 'disabled' }}>Create Live VR Stream</button></span>
...
<script src="/js/vr.livestream.js?v=1.5" type="text/javascript"></script>
@stop