...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1><i class="fa fa-list"></i> VR Playlists</h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">VR Playlists</li>
        </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="col-md-12">
                <div id="page-header-wrapper">  
                    <div id="page-header-body">
                        <div id="text">Create manually or dynamically generated playlists.</div>
                        ...
                        <div id="users-buttons">
                            <div style="display: inline-block; float: left;">
                                <span class="dropdown header">
                                    <div class="btn-group">
                                        <button class="btn bg-olive" type="button" {{ (in_array("PLAYLIST_ADD", $permissions))? '' : 'disabled' }}><span class="text">Create Playlist</span></button>
                                        <button aria-expanded="true" data-toggle="dropdown" class="btn bg-olive dropdown-toggle" id="add-playlist" {{ (in_array("PLAYLIST_ADD", $permissions))? '' : 'disabled' }}><span class="caret"></span></button>
                                        <ul aria-labelledby="dropdownMenu" role="menu" id="menu" class="dropdown-menu playlist-add">
                                            <li role="presentation"><a onclick="smhPlaylists.addManual();" tabindex="-1" role="menuitem">Manual</a></li>
                                            <li role="presentation"><a onclick="smhPlaylists.addRB();" tabindex="-1" role="menuitem">Rule Based</a></li>
                                        </ul>
                                    </div>
                                </span>
                            </div>
                            <div style="display: inline-block; float: right;">
                                <div class="pull-left" id="dwnld-csv"><div id="loading"><img height="20px" src="/img/loading.gif"></div><a onclick="smhPlaylists.exportMetaData()">Export to Excel <img height="20px" src="/img/xls-icon.jpg"></a></div>
                                <span class="dropdown header">
                                    <div class="btn-group">
                                        ...
                                        <ul aria-labelledby="dropdownMenu" role="menu" id="menu" class="dropdown-menu playlist-bulk">
                                            <li role="presentation"><a onclick="smhPlaylists.bulkDeleteModal();" tabindex="-1" role="menuitem">Delete</a></li>
                                        </ul>
                                    </div>
                                </span>
                            </div>
...
<script src="/js/KalturaEmbedCodeGeneratorVR.js?v=1" type="text/javascript"></script>
...
<script src="/js/vr.playlists.js?v=1.5" type="text/javascript"></script>
@stop