...
<!--    <section class="content-header">
        <h1><i class="fa fa-cog"></i> Live Transcoding</h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Live Transcoding</li>
        </ol>
    </section>-->
    <!-- Main content -->
            ...
            <div class="col-md-12">
                <div id="page-header-wrapper">
                    <div id="page-header-body">
                        <div id="text">Deliver adaptive bitrate streaming to multiple devices from a single RTMP origin stream.</div>
                    ...
                    <div class="box-body">
                        <div id="users-buttons">
                            <div style="display: inline-block; float: left;">
                                <button class="btn btn-block bg-olive" id="add-ac" onclick="smhTrans.addTrans();" {{ (in_array("TRANSCODING_ADD", $permissions))? : 'disabled' }} disabled>Add Profile</button>
                            </div>
...
<script src="/js/trans.live.js?v=1" type="text/javascript"></script>
@stop