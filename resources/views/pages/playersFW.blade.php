                                ...
                                <span class="dropdown header">
                                    <div class="btn-group">
                                        ...
                                        <ul aria-labelledby="dropdownMenu" role="menu" id="menu" class="dropdown-menu playlist-add">
                                            <li role="presentation"><a onclick="smhPlayers.addPlayer(23448209);" tabindex="-1" role="menuitem">Single Video Player</a></li>
                                            <li role="presentation"><a onclick="smhPlayers.addPlayer(23448210);" tabindex="-1" role="menuitem">Playlist Player</a></li>
                                            <!--                                            <li role="presentation"><a onclick="smhPlayers.addPlayer(6709440);" tabindex="-1" role="menuitem">Vertical Playlist Player</a></li>-->
                                            <li role="presentation"><a onclick="smhPlayers.addPlayer(23448211);" tabindex="-1" role="menuitem">Channel Playlist Player</a></li>
                                        </ul>
                                    </div>
                                </span>
                            </div>
...
@section('footer')
<script src="http://meddev2/p/104/sp/10400/embedIframeJs/uiconf_id/23448170/partner_id/104"></script>
...
<script src="/js/fw.players.js?v=1.5" type="text/javascript"></script>
@stop