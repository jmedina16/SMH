...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1><i class="ion ion-radio-waves"></i> Social Broadcasting</h1>
        <ol class="breadcrumb">
                    ...
                    <div class="box-body">
                        <div id="social-guides">
                            ...
                            <div id="social-guides-links">
                                ...
                                <a href="/user_guide/fb_setup_guide.pdf" target="_blank">Facebook Integration Guide <i class="fa fa-external-link" style="width: 100%; text-align: center; display: inline; font-size: 12px;"></i></a><br>
...
<script src="/js/vr.social_network.js?v=1.5" type="text/javascript"></script>
@stop