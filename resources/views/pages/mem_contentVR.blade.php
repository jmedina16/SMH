            ...
            <div class="col-md-12">
                <div id="page-header-wrapper">
                    <div id="page-header-body">
                        <div id="text">Easily setup your entries for your membership users by using the setup wizard.</div>
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="rs-right-header"><a href="#" id="refresh" onclick="smhMEM.getContent();"><i class="fa fa-refresh"></i> Refresh</a></div>
                    </div>
                    <div class="box-body">
                                ...
                                <span class="dropdown header">
                                    <div class="btn-group">
                                        ...
                                        <ul aria-labelledby="dropdownMenu" role="menu" id="menu" class="dropdown-menu playlist-add">
                                            <li role="presentation"><a onclick="smhMEM.addSingleEntry();" tabindex="-1" role="menuitem">Single Entry</a></li>
                                            <li role="presentation"><a onclick="smhMEM.addPlistEntry();" tabindex="-1" role="menuitem">Playlist</a></li>
                                        </ul>
                                    </div>
                                </span>
                            </div>
...
<script src="/js/vr.mem.content.js?v=1" type="text/javascript"></script>
@stop