...
<html lang="en">
    <head>
        ...
        <link href="/css/vr.style.css?v=1.5" rel="stylesheet">
        ...
        <style id="user-style-top">
            ...
            #logo, #vr-center-title, .skin-blue .main-header .navbar .sidebar-toggle, .skin-blue .main-header .navbar .nav > li > a, #user-header-wrapper, #account-header{
    ...
    <body class="skin-blue fixed sidebar-mini">
        ...
        <div class="wrapper">
            <header class="main-header">
                ...
                <nav class="navbar navbar-static-top" role="navigation">
                    ...
                    <div id="vr-center-title">VR Platform: The World's First Live and On Demand<br>Streaming, Recording and Rendering all under one cloud.</div>
                </nav>
            </header>
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">  
                        ...
                        <li class="{{ Request::is('content') || Request::is('playlists') || Request::is('categories') ? 'active' : '' }}">
                            <a href="#">
                        ...
                        <li class="{{ Request::is('social_broadcasting') ? 'active' : '' }}">
                            <a href="/social_broadcasting">
                                ...
                                <span style="position: relative; top: -5px;">Social Broadcasting</span>
                            </a>
                        </li>                       
                        @endif     
                        ...
                        <li class="{{ Request::is('transcoding') ? 'active' : '' }}">
                            <a href="/transcoding">
                        ...
                        <li class="{{ Request::is('ppv/payment_gateway') || Request::is('ppv/email_templates') || Request::is('ppv/email_configuration') || Request::is('ppv/users') || Request::is('ppv/tickets') || Request::is('ppv/content') || Request::is('ppv/orders') || Request::is('ppv/affiliates') ? 'active' : '' }}">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="{{ Request::is('ppv/email_templates') || Request::is('ppv/email_configuration')? 'active' : '' }}">
                                    <a href="#"><i class="fa fa-envelope-o"></i> Email <i class="fa fa-angle-left pull-right"></i></a>
                        ...
                        <li class="treeview {{ Request::is('dashboard') || Request::is('player_stats/content_reports') || Request::is('player_stats/geo_distribution') || Request::is('player_stats/system_reports') || Request::is('player_stats/live_reports') || Request::is('historical_stats') ? 'active' : '' }}">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li class="{{ Request::is('dashboard')? 'active' : '' }}"><a href="/dashboard"><i class="fa fa-dashboard"></i> Dashboard</a></li>
                                ...
                                <li class="{{ Request::is('player_stats/content_reports') || Request::is('player_stats/geo_distribution') || Request::is('player_stats/system_reports') || Request::is('player_stats/live_reports') ? 'active' : '' }}">
                                    <a href="#"><i class="fa fa-line-chart"></i> Player Statistics <i class="fa fa-angle-left pull-right"></i></a>
                        ...
                        <li class="{{ Request::is('users') || Request::is('roles') || Request::is('reseller') ? 'active' : '' }}">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li class="{{ Request::is('users')? 'active' : '' }}"><a href="/users"><i class="fa fa-users"></i> Users</a></li>
                                <li class="{{ Request::is('roles')? 'active' : '' }}"><a href="/roles"><i class="fa fa-check-square-o"></i> Roles</a></li>
                        ...
                        <li class="{{ Request::is('help') ? 'active' : '' }}">
                            ...
                            <ul class="treeview-menu">
                                <li class="{{ Request::is('help')? 'active' : '' }}"><a href="/help"><i class="fa fa-ticket"></i> Open A New Ticket</a></li>
                                <li><a href="#" onclick="window.open('http://help.streamingmediahosting.com/tickets.php', '_blank')"><i class="fa fa-check-square-o"></i> Check Ticket Status</a></li>
            ...
            <aside class="control-sidebar control-sidebar-dark">                
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="control-sidebar-layout-tab">      
                        <h3 class="control-sidebar-heading">Layout Settings</h3>
        ...
        <script src="/js/vr.main.js?v=1" type="text/javascript"></script>
